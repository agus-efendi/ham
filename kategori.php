    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Alibaba Shop <span class="glyphicon glyphicon-shopping-cart"></span></a>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
              ...
              <div class="jumbotron">
                  <h1>Alibaba Shop <img src="assets/img/keranjang.png" width="15%" height="15%"></h1>
                  <p>
